...
function createPopupAppMock(pageType: PopupPageType) {
  ...
  return {
    ...
    showKimiChat: ref(true),
    kimiChatTranscript: ref([]),
    kimiChatBusy: ref(false),
    kimiChatSessionId: ref<string | null>(null),
    kimiChatDraftMessage: ref(""),

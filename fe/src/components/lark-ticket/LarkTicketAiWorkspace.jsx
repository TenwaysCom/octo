...
export function LarkTicketAiWorkspace({ apiBaseUrl, mode, groups, visibleColumns, collapsedGroups = [], onLarkTicketDetailLinkClick, onToggleGroup = () => {}, collapsedSubgroups = [], onToggleSubgroup = () => {} }) {

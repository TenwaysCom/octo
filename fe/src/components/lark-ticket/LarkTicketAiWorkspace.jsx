...
export function LarkTicketAiWorkspace({ apiBaseUrl, mode, groups, visibleColumns, collapsedGroups = [], onTicketContextMenu, onLarkTicketDetailLinkClick, onToggleGroup = () => {}, collapsedSubgroups = [], onToggleSubgroup = () => {} }) {

...
import { getActiveProfile, listProfiles, loadConfig, removeProfile, resolveServerUrl, saveConfig, setActiveProfile, setProfileStrictMode, } from "../src/config.js";
...
test("strict Profile binds the configured server and cannot be overridden by an environment URL", async () => {
    ...
    try {
        ...
        assert.throws(() => resolveServerUrl({ serverUrl: "https://octo.example", strictMode: "host" }, { OCTO_SERVER_URL: "https://other.example" }), /STRICT_PROFILE_SERVER_MISMATCH/);
